...
namespace Compiler.Language.Nodes {
    public class RecordFieldNode : ExpressionNode {
        ...
        public RecordFieldNode(Token identifierToken, List<Token> types) : base(identifierToken, ExpressionKind.RecordField) {
            this.AnnotationNode = null;
            this.IdToken = identifierToken;
            this.TypesTokens = types;
        }
        public RecordFieldNode(AnnotationNode? annotation, Token identifierToken, List<Token> types) : base(identifierToken, ExpressionKind.RecordField) {
